...
public class RecyclageService {
    ...
    private Recyclage mapResultSetToRecyclage(ResultSet rs) throws SQLException {
        ...
        TypeRecyclage type = TypeRecyclage.fromLibelle(rs.getString("type"));
...
public Map<String, Integer> getRecyclageCountsByType() throws SQLException {
    Map<String, Integer> typeCounts = new HashMap<>();

    String query = "SELECT type, COUNT(*) as count FROM recyclage GROUP BY type";
    try (Connection conn = DatabaseService.getConnection();
