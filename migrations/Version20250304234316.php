 ...
 */
final class Version20250304234316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, id_utilisateur INT NOT NULL, message LONGTEXT NOT NULL, statut VARCHAR(50) NOT NULL, type_reclamation VARCHAR(255) NOT NULL, date_reclamation DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, titre VARCHAR(255) NOT NULL, priorite VARCHAR(20) DEFAULT NULL, categorie VARCHAR(50) DEFAULT NULL, INDEX IDX_CE60640450EAE44 (id_utilisateur), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reponse (id_reponse INT AUTO_INCREMENT NOT NULL, id_reclamation INT DEFAULT NULL, id_utilisateur INT NOT NULL, contenu LONGTEXT NOT NULL, date_reponse DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, UNIQUE INDEX UNIQ_5FB6DEC7D672A9F3 (id_reclamation), INDEX IDX_5FB6DEC750EAE44 (id_utilisateur), PRIMARY KEY(id_reponse)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, role VARCHAR(50) NOT NULL, date_inscription DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', available_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', delivered_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE blog ADD CONSTRAINT FK_C015514350EAE44 FOREIGN KEY (id_utilisateur) REFERENCES utilisateur (id)');
        $this->addSql('ALTER TABLE blog_like ADD CONSTRAINT FK_4CB3CC2350EAE44 FOREIGN KEY (id_utilisateur) REFERENCES utilisateur (id)');
        ...
        $this->addSql('ALTER TABLE echange ADD CONSTRAINT FK_B577E3BF50EAE44 FOREIGN KEY (id_utilisateur) REFERENCES utilisateur (id)');
        $this->addSql('ALTER TABLE objet ADD CONSTRAINT FK_46CD4C3850EAE44 FOREIGN KEY (id_utilisateur) REFERENCES utilisateur (id)');
        ...
        $this->addSql('ALTER TABLE recyclage ADD CONSTRAINT FK_C737D7D550EAE44 FOREIGN KEY (id_utilisateur) REFERENCES utilisateur (id)');
        ...
        $this->addSql('ALTER TABLE reponse ADD CONSTRAINT FK_5FB6DEC750EAE44 FOREIGN KEY (id_utilisateur) REFERENCES utilisateur (id)');
        ...
        $this->addSql('ALTER TABLE tutorial ADD CONSTRAINT FK_C66BFFE950EAE44 FOREIGN KEY (id_utilisateur) REFERENCES utilisateur (id)');
    }
