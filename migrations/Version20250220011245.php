 ...
 */
final class Version20250220011245 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE blog (id_article INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, contenu LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, date_publication DATETIME NOT NULL, PRIMARY KEY(id_article)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commentaire_blog (id INT AUTO_INCREMENT NOT NULL, blog_id INT NOT NULL, contenu VARCHAR(255) NOT NULL, datecommentaire DATETIME NOT NULL, INDEX IDX_29ED9511DAE07E97 (blog_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commentaire_blog ADD CONSTRAINT FK_29ED9511DAE07E97 FOREIGN KEY (blog_id) REFERENCES blog (id_article)');
