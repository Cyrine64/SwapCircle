...
final class Version20250225102106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE echange (id_echange INT AUTO_INCREMENT NOT NULL, id_objet INT NOT NULL, id_utilisateur INT NOT NULL, name_echange VARCHAR(255) NOT NULL, image_echange VARCHAR(255) NOT NULL, date_echange DATETIME NOT NULL, message LONGTEXT NOT NULL, statut VARCHAR(20) NOT NULL, INDEX IDX_B577E3BFA8480D08 (id_objet), INDEX IDX_B577E3BF50EAE44 (id_utilisateur), PRIMARY KEY(id_echange)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE objet (id_objet INT AUTO_INCREMENT NOT NULL, id_utilisateur INT NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, etat VARCHAR(50) NOT NULL, date_ajout DATETIME NOT NULL, image VARCHAR(255) DEFAULT NULL, categorie VARCHAR(255) NOT NULL, INDEX IDX_46CD4C3850EAE44 (id_utilisateur), PRIMARY KEY(id_objet)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE recyclage (id_recyclage INT AUTO_INCREMENT NOT NULL, id_utilisateur INT NOT NULL, id_objet INT NOT NULL, type_recyclage VARCHAR(50) NOT NULL, date_recyclage DATETIME NOT NULL, commentaire LONGTEXT DEFAULT NULL, INDEX IDX_C737D7D550EAE44 (id_utilisateur), INDEX IDX_C737D7D5A8480D08 (id_objet), PRIMARY KEY(id_recyclage)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
