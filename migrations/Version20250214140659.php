...
final class Version20250214140659 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reclamation (id_reclamation INT AUTO_INCREMENT NOT NULL, id_utilisateur INT NOT NULL, message LONGTEXT NOT NULL, statut VARCHAR(50) NOT NULL, type_reclamation VARCHAR(255) NOT NULL, date_reclamation DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, titre VARCHAR(255) NOT NULL, priorite VARCHAR(20) DEFAULT NULL, categorie VARCHAR(50) DEFAULT NULL, INDEX IDX_CE60640450EAE44 (id_utilisateur), PRIMARY KEY(id_reclamation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
